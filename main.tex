...
\thesistitle{TITULO DE LA TESIS} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{Ingeniería civil Informática (se refiere a eso?) y Master of Science in Data Science} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
