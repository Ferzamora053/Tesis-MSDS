...
\begin{figure}[th]
  \centering
  \includegraphics[width=\textwidth]{Figures/Resumen-grafico.png}
...
Explicación paso a paso metodología.
...
\section{Generación de \enquote{super-categorías}}
  ...
  \subsection{El agente validador}
    ...
    \begin{itemize}
      ...
      \item \textbf{Detección de Alucinaciones:} Identifica agrupaciones erroneas o etiquetas inventadas que no corresponden a la taxonomía comercial real.
    \end{itemize}
  ...
  \subsection{El agente retroalimentador}
    La función principal este agente se activa únicamente cuando el agente validador rechaza una propuesta. El agente retroalimentador recibe el reporte de error o inconsistencia generado por el validador y lo procesa para construir un nuevo \textit{prompt} o conjunto de instrucciones refinadas.
