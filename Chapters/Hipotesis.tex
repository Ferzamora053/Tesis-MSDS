...
\begin{quote}
  \textit{El uso de Modelos de Lenguaje Grande (LLM) para generar \enquote{super-categorías} unifica semánticamente los catálogos de productos de distintas unidades de negocio, produciendo una mejora estadísticamente significativa ($p < 0.05$) en NDCG@K y Recall@K en sistemas de recomendación, especialmente en escenarios de \enquote{cold-start} de usuario.}
\end{quote}
...
\section{Objetivos}
  ...
  Desarrollar y evaluar una metodología basada en Modelos de Lenguaje Grande (LLM) para generar \enquote{super-categorías} que permitan mejorar el rendimiento del sistema de recomendación del grupo Falabella en escenarios de \enquote{cold-start} de usuario, midiendo su impacto en métricas de ranking como NDCG@K y Recall@K.
